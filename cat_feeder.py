...
async def main():
    ...
    async with stdio_client(server_params) as (read, write):
        ...
        async with ClientSession(read, write) as session:
            ...
            prompt="Ты - ассистент по кормлению кота. Пользователь вводит вес кота. Если вес равен 5 или больше 5,"\
                  "ты гладишь кота. Если вес меньше 5, то ты кормишь кота. Если вес некорректный, нужно сообщить об ошибке"
